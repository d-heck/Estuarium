...
public class MangroveLevel extends Level{
	...
	private void createAcceptedList(){
		...
		acceptedOrganisms.add(new Organism("Barnacle",true,"I attach myself to the roots of mangroves.","resources/images/barnacle.png",800,350,"Creatures that grow on hard surfaces underwater."));
