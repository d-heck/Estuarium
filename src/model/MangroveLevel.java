...
public class MangroveLevel extends Level{
	...
	private void createAcceptedList(){
		...
		acceptedOrganisms.add(new Organism("Shore Purslane",true,"I grow well in the always-damp soil.","resources/images/shorepurslane.png",150,400, "A flower that can grow on a swampy riverside."));
	}//createAcceptedList
	...
	private void createUnacceptedList(){
		...
		unacceptedOrganisms.add(new Organism("Spotted Turtle",false,"I live in fresh water.","resources/images/spottedturtle.png",200,240, "An animal that lives near bodies of freshwater."));
