...
public class SaltMarshLevel extends Level{
	...
	private void createUnacceptedList(){
		...
		unacceptedOrganisms.add(new Organism("Lynx",false,"I live in forest, mountain, or desert regions.","resources/images/lynx.png",200,20));
		unacceptedOrganisms.add(new Organism("Purple Loosestrife",false,"I am an invasive species.","resources/images/purpleloosestrife.png",-20,300));
